...
///
/// \file     atomicreal_test_rev.cpp
/// \brief    Test on support of SpecAtomic, SpecReal and SpecRealInd (reverse iteration)
...
void seq_test()
{
  ...
  for (long long int i = N-1+DESPL; i >= 0+DESPL; i--) {
    ...
    mywait(DelaySeconds);
#endif
    sres0_c += static_cast<char>(Vals[i-DESPL]); sres0_uc += static_cast<unsigned char>(Vals[i-DESPL]); sres0_i += static_cast<int>(Vals[i-DESPL]);
    sres0_u += static_cast<unsigned int>(Vals[i-DESPL]); sres0_ll += static_cast<long long int>(Vals[i-DESPL]); sres0_ull += static_cast<unsigned long long int>(Vals[i-DESPL]);
    sres2_f += static_cast<float>(Vals[i-DESPL]); sres2_d += static_cast<double>(Vals[i-DESPL]); sres2_l += static_cast<ldouble>(Vals[i-DESPL]);
    sres2i_f += static_cast<float>(Vals[i-DESPL]); sres2i_d += static_cast<double>(Vals[i-DESPL]); sres2i_l += static_cast<ldouble>(Vals[i-DESPL]);
    sres3_f += static_cast<float>(Vals[i-DESPL]); sres3_d += static_cast<double>(Vals[i-DESPL]); sres3_l += static_cast<ldouble>(Vals[i-DESPL]);
    sres3i_f += static_cast<float>(Vals[i-DESPL]); sres3i_d += static_cast<double>(Vals[i-DESPL]); sres3i_l += static_cast<ldouble>(Vals[i-DESPL]);
    sres4_f += static_cast<float>(Vals[i-DESPL]); sres4_d += static_cast<double>(Vals[i-DESPL]); sres4_l += static_cast<ldouble>(Vals[i-DESPL]);
    sres4i_f += static_cast<float>(Vals[i-DESPL]); sres4i_d += static_cast<double>(Vals[i-DESPL]); sres4i_l += static_cast<ldouble>(Vals[i-DESPL]);
    sres5_f += static_cast<float>(Vals[i-DESPL]); sres5_d += static_cast<double>(Vals[i-DESPL]); sres5_l += static_cast<ldouble>(Vals[i-DESPL]);
    sres5i_f += static_cast<float>(Vals[i-DESPL]); sres5i_d += static_cast<double>(Vals[i-DESPL]); sres5i_l += static_cast<ldouble>(Vals[i-DESPL]);
    sres6_f += static_cast<float>(Vals[i-DESPL]); sres6_d += static_cast<double>(Vals[i-DESPL]); sres6_l += static_cast<ldouble>(Vals[i-DESPL]);
    sres6i_f += static_cast<float>(Vals[i-DESPL]); sres6i_d += static_cast<double>(Vals[i-DESPL]); sres6i_l += static_cast<ldouble>(Vals[i-DESPL]);
  }
...
bool lambda_test()
{
  const auto loop_f = [&](const long long int i, SpecLib::SpecAtomic<char>& res0_c, SpecLib::SpecAtomic<unsigned char>& res0_uc, SpecLib::SpecAtomic<int>& res0_i, SpecLib::SpecAtomic<unsigned int>& res0_u, SpecLib::SpecAtomic<long long int>& res0_ll, SpecLib::SpecAtomic<unsigned long long int>& res0_ull,
...
//  res0_c += static_cast<char>(Vals[i-DESPL]); res0_uc += static_cast<unsigned char>(Vals[i-DESPL]); res0_i += static_cast<int>(Vals[i-DESPL]);
//  res0_u += static_cast<unsigned int>(Vals[i-DESPL]); res0_ll += static_cast<long long int>(Vals[i-DESPL]); res0_ull += static_cast<unsigned long long int>(Vals[i-DESPL]);
//  res2_f += static_cast<float>(Vals[i-DESPL]); res2_d += static_cast<double>(Vals[i-DESPL]); res2_l += static_cast<ldouble>(Vals[i-DESPL]);
//  res2i_f += static_cast<float>(Vals[i-DESPL]); res2i_d += static_cast<double>(Vals[i-DESPL]); res2i_l += static_cast<ldouble>(Vals[i-DESPL]);
//  res3_f += static_cast<float>(Vals[i-DESPL]); res3_d += static_cast<double>(Vals[i-DESPL]); res3_l += static_cast<ldouble>(Vals[i-DESPL]);
//  res3i_f += static_cast<float>(Vals[i-DESPL]); res3i_d += static_cast<double>(Vals[i-DESPL]); res3i_l += static_cast<ldouble>(Vals[i-DESPL]);
//  res4_f += static_cast<float>(Vals[i-DESPL]); res4_d += static_cast<double>(Vals[i-DESPL]); res4_l += static_cast<ldouble>(Vals[i-DESPL]);
//  res4i_f += static_cast<float>(Vals[i-DESPL]); res4i_d += static_cast<double>(Vals[i-DESPL]); res4i_l += static_cast<ldouble>(Vals[i-DESPL]);
//  res5_f += static_cast<float>(Vals[i-DESPL]); res5_d += static_cast<double>(Vals[i-DESPL]); res5_l += static_cast<ldouble>(Vals[i-DESPL]);
//  res5i_f += static_cast<float>(Vals[i-DESPL]); res5i_d += static_cast<double>(Vals[i-DESPL]); res5i_l += static_cast<ldouble>(Vals[i-DESPL]);
//  res6_f += static_cast<float>(Vals[i-DESPL]); res6_d += static_cast<double>(Vals[i-DESPL]); res6_l += static_cast<ldouble>(Vals[i-DESPL]);
//  res6i_f += static_cast<float>(Vals[i-DESPL]); res6i_d += static_cast<double>(Vals[i-DESPL]); res6i_l += static_cast<ldouble>(Vals[i-DESPL]);
    res0_c.fetch_add(static_cast<char>(Vals[i-DESPL]), std::memory_order_relaxed); res0_uc.fetch_add(static_cast<unsigned char>(Vals[i-DESPL]), std::memory_order_relaxed); res0_i.fetch_add(static_cast<int>(Vals[i-DESPL]), std::memory_order_relaxed);
    res0_u.fetch_add(static_cast<unsigned int>(Vals[i-DESPL]), std::memory_order_relaxed); res0_ll.fetch_add(static_cast<long long int>(Vals[i-DESPL]), std::memory_order_relaxed); res0_ull.fetch_add(static_cast<unsigned long long int>(Vals[i-DESPL]), std::memory_order_relaxed);
    res2_f.fetch_add(static_cast<float>(Vals[i-DESPL]), std::memory_order_relaxed); res2_d.fetch_add(static_cast<double>(Vals[i-DESPL]), std::memory_order_relaxed); res2_l.fetch_add(static_cast<ldouble>(Vals[i-DESPL]), std::memory_order_relaxed);
    res2i_f.fetch_add(static_cast<float>(Vals[i-DESPL]), std::memory_order_relaxed); res2i_d.fetch_add(static_cast<double>(Vals[i-DESPL]), std::memory_order_relaxed); res2i_l.fetch_add(static_cast<ldouble>(Vals[i-DESPL]), std::memory_order_relaxed);
    res3_f.fetch_add(static_cast<float>(Vals[i-DESPL]), std::memory_order_relaxed); res3_d.fetch_add(static_cast<double>(Vals[i-DESPL]), std::memory_order_relaxed); res3_l.fetch_add(static_cast<ldouble>(Vals[i-DESPL]), std::memory_order_relaxed);
    res3i_f.fetch_add(static_cast<float>(Vals[i-DESPL]), std::memory_order_relaxed); res3i_d.fetch_add(static_cast<double>(Vals[i-DESPL]), std::memory_order_relaxed); res3i_l.fetch_add(static_cast<ldouble>(Vals[i-DESPL]), std::memory_order_relaxed);
    res4_f.fetch_add(static_cast<float>(Vals[i-DESPL]), std::memory_order_relaxed); res4_d.fetch_add(static_cast<double>(Vals[i-DESPL]), std::memory_order_relaxed); res4_l.fetch_add(static_cast<ldouble>(Vals[i-DESPL]), std::memory_order_relaxed);
    res4i_f.fetch_add(static_cast<float>(Vals[i-DESPL]), std::memory_order_relaxed); res4i_d.fetch_add(static_cast<double>(Vals[i-DESPL]), std::memory_order_relaxed); res4i_l.fetch_add(static_cast<ldouble>(Vals[i-DESPL]), std::memory_order_relaxed);
    res5_f.fetch_add(static_cast<float>(Vals[i-DESPL]), std::memory_order_relaxed); res5_d.fetch_add(static_cast<double>(Vals[i-DESPL]), std::memory_order_relaxed); res5_l.fetch_add(static_cast<ldouble>(Vals[i-DESPL]), std::memory_order_relaxed);
    res5i_f.fetch_add(static_cast<float>(Vals[i-DESPL]), std::memory_order_relaxed); res5i_d.fetch_add(static_cast<double>(Vals[i-DESPL]), std::memory_order_relaxed); res5i_l.fetch_add(static_cast<ldouble>(Vals[i-DESPL]), std::memory_order_relaxed);
    res6_f.fetch_add(static_cast<float>(Vals[i-DESPL]), std::memory_order_relaxed); res6_d.fetch_add(static_cast<double>(Vals[i-DESPL]), std::memory_order_relaxed); res6_l.fetch_add(static_cast<ldouble>(Vals[i-DESPL]), std::memory_order_relaxed);
    res6i_f.fetch_add(static_cast<float>(Vals[i-DESPL]), std::memory_order_relaxed); res6i_d.fetch_add(static_cast<double>(Vals[i-DESPL]), std::memory_order_relaxed); res6i_l.fetch_add(static_cast<ldouble>(Vals[i-DESPL]), std::memory_order_relaxed);
  };
  ...
  const bool test_ok = bench(N-1+DESPL, -1LL+DESPL, -1LL, loop_f, reset_result, test_f, avg_time, res0_c, res0_uc, res0_i, res0_u, res0_ll, res0_ull,
...
{
  const auto loop_f = [&](const SpecLib::ExCommonSpecInfo_t& cs, const long long int begin, const long long int end, const long long int step, SpecLib::SpecAtomic<char>& res0_c, SpecLib::SpecAtomic<unsigned char>& res0_uc, SpecLib::SpecAtomic<int>& res0_i, SpecLib::SpecAtomic<unsigned int>& res0_u, SpecLib::SpecAtomic<long long int>& res0_ll, SpecLib::SpecAtomic<unsigned long long int>& res0_ull,
                                                                                                                          SpecLib::SpecAtomic<SpecRealAbsF>& res2_f, SpecLib::SpecAtomic<SpecRealAbsD>& res2_d, SpecLib::SpecAtomic<SpecRealAbsL>& res2_l, SpecLib::SpecAtomic<SpecRealIndAbsF>& res2i_f, SpecLib::SpecAtomic<SpecRealIndAbsD>& res2i_d, SpecLib::SpecAtomic<SpecRealIndAbsL>& res2i_l,
                                                                                                                          SpecLib::SpecAtomic<SpecRealRelF>& res3_f, SpecLib::SpecAtomic<SpecRealRelD>& res3_d, SpecLib::SpecAtomic<SpecRealRelL>& res3_l, SpecLib::SpecAtomic<SpecRealIndRelF>& res3i_f, SpecLib::SpecAtomic<SpecRealIndRelD>& res3i_d, SpecLib::SpecAtomic<SpecRealIndRelL>& res3i_l,
                                                                                                                          SpecLib::SpecAtomic<SpecRealUlpF>& res4_f, SpecLib::SpecAtomic<SpecRealUlpD>& res4_d, SpecLib::SpecAtomic<SpecRealUlpL>& res4_l, SpecLib::SpecAtomic<SpecRealIndUlpF>& res4i_f, SpecLib::SpecAtomic<SpecRealIndUlpD>& res4i_d, SpecLib::SpecAtomic<SpecRealIndUlpL>& res4i_l,
                                                                                                                          SpecLib::SpecAtomic<SpecRealAbsRelF>& res5_f, SpecLib::SpecAtomic<SpecRealAbsRelD>& res5_d, SpecLib::SpecAtomic<SpecRealAbsRelL>& res5_l, SpecLib::SpecAtomic<SpecRealIndAbsRelF>& res5i_f, SpecLib::SpecAtomic<SpecRealIndAbsRelD>& res5i_d, SpecLib::SpecAtomic<SpecRealIndAbsRelL>& res5i_l,
...
static inline void sf(const long long int i, SpecLib::SpecAtomic<char>& res0_c, SpecLib::SpecAtomic<unsigned char>& res0_uc, SpecLib::SpecAtomic<int>& res0_i, SpecLib::SpecAtomic<unsigned int>& res0_u, SpecLib::SpecAtomic<long long int>& res0_ll, SpecLib::SpecAtomic<unsigned long long int>& res0_ull,
                                      SpecLib::SpecAtomic<SpecRealAbsF>& res2_f, SpecLib::SpecAtomic<SpecRealAbsD>& res2_d, SpecLib::SpecAtomic<SpecRealAbsL>& res2_l, SpecLib::SpecAtomic<SpecRealIndAbsF>& res2i_f, SpecLib::SpecAtomic<SpecRealIndAbsD>& res2i_d, SpecLib::SpecAtomic<SpecRealIndAbsL>& res2i_l,
                                      SpecLib::SpecAtomic<SpecRealRelF>& res3_f, SpecLib::SpecAtomic<SpecRealRelD>& res3_d, SpecLib::SpecAtomic<SpecRealRelL>& res3_l, SpecLib::SpecAtomic<SpecRealIndRelF>& res3i_f, SpecLib::SpecAtomic<SpecRealIndRelD>& res3i_d, SpecLib::SpecAtomic<SpecRealIndRelL>& res3i_l,
                                      SpecLib::SpecAtomic<SpecRealUlpF>& res4_f, SpecLib::SpecAtomic<SpecRealUlpD>& res4_d, SpecLib::SpecAtomic<SpecRealUlpL>& res4_l, SpecLib::SpecAtomic<SpecRealIndUlpF>& res4i_f, SpecLib::SpecAtomic<SpecRealIndUlpD>& res4i_d, SpecLib::SpecAtomic<SpecRealIndUlpL>& res4i_l,
                                      SpecLib::SpecAtomic<SpecRealAbsRelF>& res5_f, SpecLib::SpecAtomic<SpecRealAbsRelD>& res5_d, SpecLib::SpecAtomic<SpecRealAbsRelL>& res5_l, SpecLib::SpecAtomic<SpecRealIndAbsRelF>& res5i_f, SpecLib::SpecAtomic<SpecRealIndAbsRelD>& res5i_d, SpecLib::SpecAtomic<SpecRealIndAbsRelL>& res5i_l,
...
bool sf_test()
{
  const bool test_ok = bench(N-1+DESPL, -1LL+DESPL, -1LL, sf, reset_result, test_f, avg_time, res0_c, res0_uc, res0_i, res0_u, res0_ll, res0_ull,
                                                                          res2_f, res2_d, res2_l, res2i_f, res2i_d, res2i_l,
                                                                          res3_f, res3_d, res3_l, res3i_f, res3i_d, res3i_l,
                                                                          res4_f, res4_d, res4_l, res4i_f, res4i_d, res4i_l,
                                                                          res5_f, res5_d, res5_l, res5i_f, res5i_d, res5i_l,
...
bool sf_loop_test()
{
  const bool test_ok = bench(N-1+DESPL, -1LL+DESPL, -1LL, sf_loop, reset_result, test_f, avg_time, res0_c, res0_uc, res0_i, res0_u, res0_ll, res0_ull,
                                                                               res2_f, res2_d, res2_l, res2i_f, res2i_d, res2i_l,
                                                                               res3_f, res3_d, res3_l, res3i_f, res3i_d, res3i_l,
                                                                               res4_f, res4_d, res4_l, res4i_f, res4i_d, res4i_l,
                                                                               res5_f, res5_d, res5_l, res5i_f, res5i_d, res5i_l,
